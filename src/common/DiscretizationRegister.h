...
static platform::RegistrarDiscretization registrarM3("mdlp3",
    [](void) -> mdlp::Discretizer* { return new mdlp::CPPFImdlp(3, std::numeric_limits<int>::max(), 3);});
static platform::RegistrarDiscretization registrarM4("mdlp4",
    [](void) -> mdlp::Discretizer* { return new mdlp::CPPFImdlp(3, std::numeric_limits<int>::max(), 4);});
static platform::RegistrarDiscretization registrarM5("mdlp5",
    [](void) -> mdlp::Discretizer* { return new mdlp::CPPFImdlp(3, std::numeric_limits<int>::max(), 5);});
